...
| MATLAB MCP unavailable | Codex setup reference in `matlab_runtime_skill/SKILL.md` | Do not report MATLAB execution evidence without a tool call or external log. |

## Runtime Decision Table

| Condition | Action |
| --- | --- |
| MATLAB files present, MCP unavailable | Create a runtime plan and ask whether to configure MATLAB MCP or proceed with static analysis. |
